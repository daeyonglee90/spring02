...
public class ReplyPager {
	...
	private int nextBlcok;	// 다음 페이지 블록
	...
	public int getNextBlcok() {
		return nextBlcok;
	}

	public void setNextBlcok(int nextBlcok) {
		this.nextBlcok = nextBlcok;
	}
